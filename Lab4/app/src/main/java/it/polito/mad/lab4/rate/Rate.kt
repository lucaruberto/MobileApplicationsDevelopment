...
fun Rate() {
    ...
    LazyColumn() {
        if(readMode){
            item {
                ratings?.forEach {
                    ReviewComponent(it.id, it.fieldName, it.reviewText, vmRatings, modifier = Modifier.padding(24.dp))
            ...
            item {
                ...
                Column {
                    Box(
                        ...
                        Text(selectedField, modifier = Modifier.padding(16.dp))
                        Icon(
                    ...
                    DropdownMenu(
                        ...
                        fieldsNotRated?.forEach { field ->
                            DropdownMenuItem(
                                text = { Text(text = field, modifier = Modifier.fillMaxWidth()) },
                                onClick = {
                                    selectedField = field
                                    expanded = false
                                },
                ...
                InsertReviewForm(modifier = Modifier.padding(24.dp))
                Row(
                    horizontalArrangement = Arrangement.Center,
                    modifier = Modifier.fillMaxWidth()
                ) {
...
@Composable
fun InsertReviewForm(modifier: Modifier/*onSaveClicked: (String) -> Unit, onCancelClicked: () -> Unit*/) {
        ...
        horizontalAlignment = Alignment.CenterHorizontally)
    {
       ...
       Row(
           ...
           Button(onClick = { /*onSaveClicked(text)*/ }) {
               Text("Save")
           }
       }
   }
